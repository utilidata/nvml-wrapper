        ...
        unsafe {
            ...
            Ok(ConfidentialComputeGpuAttestationReport {
                ...
                attestation_report: report.attestationReport
                    [..report.attestationReportSize as usize]
                    .to_vec(),
                ...
                cec_attestation_report: report.cecAttestationReport
                    [..report.cecAttestationReportSize as usize]
                    .to_vec(),
            })
        }
    }
    ...
    fn field_values_for() {
        ...
        test_with_device(3, &nvml, |device| {
            device.field_values_for(&[
                ...
                FieldId(NVML_FI_DEV_RETIRED_SBE),
                FieldId(NVML_FI_DEV_RETIRED_DBE),
                FieldId(NVML_FI_DEV_RETIRED_PENDING),
                ...
                FieldId(NVML_FI_DEV_RETIRED_PENDING_SBE),
                FieldId(NVML_FI_DEV_RETIRED_PENDING_DBE),
                FieldId(NVML_FI_DEV_PCIE_REPLAY_COUNTER),
                FieldId(NVML_FI_DEV_PCIE_REPLAY_ROLLOVER_COUNTER),
                FieldId(NVML_FI_DEV_REMAPPED_COR),
                FieldId(NVML_FI_DEV_REMAPPED_UNC),
                FieldId(NVML_FI_DEV_REMAPPED_PENDING),
                FieldId(NVML_FI_DEV_REMAPPED_FAILURE),
                FieldId(NVML_FI_DEV_NVSWITCH_CONNECTED_LINK_COUNT),
                FieldId(NVML_FI_DEV_PCIE_L0_TO_RECOVERY_COUNTER),
                FieldId(NVML_FI_DEV_C2C_LINK_COUNT),
                FieldId(NVML_FI_DEV_C2C_LINK_GET_STATUS),
                FieldId(NVML_FI_DEV_C2C_LINK_GET_MAX_BW),
                FieldId(NVML_FI_DEV_PCIE_COUNT_CORRECTABLE_ERRORS),
                FieldId(NVML_FI_DEV_PCIE_COUNT_NAKS_RECEIVED),
                FieldId(NVML_FI_DEV_PCIE_COUNT_RECEIVER_ERROR),
                FieldId(NVML_FI_DEV_PCIE_COUNT_BAD_TLP),
                FieldId(NVML_FI_DEV_PCIE_COUNT_NAKS_SENT),
                FieldId(NVML_FI_DEV_PCIE_COUNT_BAD_DLLP),
                FieldId(NVML_FI_DEV_PCIE_COUNT_NON_FATAL_ERROR),
                ...
                FieldId(NVML_FI_DEV_PCIE_COUNT_LANE_ERROR),
                FieldId(NVML_FI_DEV_IS_RESETLESS_MIG_SUPPORTED),
                FieldId(NVML_FI_DEV_POWER_AVERAGE),
                FieldId(NVML_FI_DEV_POWER_INSTANT),
                FieldId(NVML_FI_DEV_POWER_MIN_LIMIT),
                FieldId(NVML_FI_DEV_POWER_MAX_LIMIT),
                FieldId(NVML_FI_DEV_POWER_DEFAULT_LIMIT),
                FieldId(NVML_FI_DEV_POWER_CURRENT_LIMIT),
                FieldId(NVML_FI_DEV_ENERGY),
                FieldId(NVML_FI_DEV_POWER_REQUESTED_LIMIT),
                FieldId(NVML_FI_DEV_TEMPERATURE_SHUTDOWN_TLIMIT),
                FieldId(NVML_FI_DEV_TEMPERATURE_SLOWDOWN_TLIMIT),
                FieldId(NVML_FI_DEV_TEMPERATURE_MEM_MAX_TLIMIT),
                FieldId(NVML_FI_DEV_TEMPERATURE_GPU_MAX_TLIMIT),
                FieldId(NVML_FI_DEV_PCIE_COUNT_TX_BYTES),
                FieldId(NVML_FI_DEV_PCIE_COUNT_RX_BYTES),
                FieldId(NVML_FI_DEV_IS_MIG_MODE_INDEPENDENT_MIG_QUERY_CAPABLE),
                FieldId(NVML_FI_DEV_RESET_STATUS),
                FieldId(NVML_FI_DEV_DRAIN_AND_RESET_STATUS),
                FieldId(NVML_FI_DEV_PCIE_OUTBOUND_ATOMICS_MASK),
                FieldId(NVML_FI_DEV_PCIE_INBOUND_ATOMICS_MASK),
                FieldId(NVML_FI_DEV_GET_GPU_RECOVERY_ACTION),
                FieldId(NVML_FI_DEV_C2C_LINK_ERROR_INTR),
                FieldId(NVML_FI_DEV_C2C_LINK_ERROR_REPLAY),
                FieldId(NVML_FI_DEV_C2C_LINK_ERROR_REPLAY_B2B),
                FieldId(NVML_FI_DEV_C2C_LINK_POWER_STATE),
                FieldId(NVML_FI_DEV_CLOCKS_EVENT_REASON_SW_POWER_CAP),
                FieldId(NVML_FI_DEV_CLOCKS_EVENT_REASON_SYNC_BOOST),
